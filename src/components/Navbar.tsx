...
//   const isLoggedIn = false; // Replace this with actual authentication status
...
//                 <Link to="/signup" className="text-gray-600 hover:text-yellow-500">Sign Up</Link>
//               </>
//             )}
//           </div>
...
//             ) : (
//               <>
//                 <Link to="/login" className="block py-2 text-gray-600">Sign Up or Login</Link>
//                 <Link to="/signup" className="block py-2 text-gray-600">Login</Link>
//               </>
//             )}
//           </div>
//         )}
